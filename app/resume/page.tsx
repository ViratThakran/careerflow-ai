    ...
    <div className="min-h-screen bg-[var(--bg-primary)]">
      ...
      <section className="py-20 px-6 text-center max-w-4xl mx-auto">
        <motion.div
          ...
          className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[rgba(0,240,255,0.1)] border border-[rgba(0,240,255,0.2)] mb-6"
        >
          <Sparkles className="w-4 h-4 text-[#00F0FF]" />
          <span className="text-sm text-[#00F0FF] font-medium">AI-Powered Resume Builder</span>
        </motion.div>
        ...
        >
          <Link href="/resume/build">
            <motion.button
              ...
              whileTap={{ scale: 0.97 }}
              className="px-8 py-4 bg-[#00F0FF] text-[#050505] rounded-full font-semibold text-lg flex items-center gap-2 hover:shadow-[0_0_40px_rgba(0,240,255,0.5)] transition-all"
            >
          ...
          <Link href="/resume/upload">
            <motion.button
              whileHover={{ scale: 1.03 }}
              whileTap={{ scale: 0.97 }}
              className="px-8 py-4 border border-[var(--border-subtle)] text-white rounded-full font-semibold text-lg flex items-center gap-2 hover:border-[rgba(0,240,255,0.3)] hover:bg-[rgba(0,240,255,0.05)] transition-all"
            >
          ...
          {features.map((feature, index) => {
            ...
            return (
              <motion.div
                ...
                className="p-6 rounded-2xl bg-[var(--bg-elevated)] border border-[var(--border-subtle)] hover:border-[rgba(0,240,255,0.3)] transition-all"
              >
                <div 
      ...
      <section className="py-20 px-6 max-w-4xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-[#9CA3AF]">Choose how you want to begin</p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Link href="/resume/build" className="group">
            <div className="p-8 rounded-2xl bg-[var(--bg-elevated)] border border-[var(--border-subtle)] hover:border-[#00F0FF] transition-all text-center">
              <div className="w-16 h-16 rounded-2xl bg-[rgba(0,240,255,0.1)] flex items-center justify-center mx-auto mb-4 group-hover:bg-[rgba(0,240,255,0.2)] transition-colors">
                <FileText className="w-8 h-8 text-[#00F0FF]" />
              </div>
              <h3 className="text-lg font-semibold text-white mb-2">Build from Scratch</h3>
              <p className="text-sm text-[#6B7280]">Create a new resume with our drag-and-drop builder</p>
            </div>
          </Link>
          ...
          <Link href="/resume/upload" className="group">
            <div className="p-8 rounded-2xl bg-[var(--bg-elevated)] border border-[var(--border-subtle)] hover:border-[#8B5CF6] transition-all text-center">
              ...
              <h3 className="text-lg font-semibold text-white mb-2">Upload & Optimize</h3>
              <p className="text-sm text-[#6B7280]">Import your existing resume for AI enhancement</p>
            </div>
          </Link>
          ...
          <Link href="/resume/templates" className="group">
            <div className="p-8 rounded-2xl bg-[var(--bg-elevated)] border border-[var(--border-subtle)] hover:border-[#10B981] transition-all text-center">
              ...
              <p className="text-sm text-[#6B7280]">Explore 12+ professional resume designs</p>
            </div>
          </Link>
        </div>
      </section>
