...
export function Testimonials() {
  ...
  return (
    <section id="testimonials" className="py-24 md:py-32 relative overflow-hidden bg-[#0a0a0f]">
      {/* Background */}
        ...
        >
          <AnimatePresence mode="wait">
            <motion.div
              ...
              className="bg-[#111118] border border-[var(--border-subtle)] rounded-[20px] p-8 md:p-12 relative"
            >
              {/* Quote icon */}
              <div className="absolute top-8 right-8 text-[#00F0FF] opacity-10">
                <Quote className="w-16 h-16" />
              </div>

              {/* Quote text */}
              <blockquote className="text-xl md:text-2xl text-[#F9FAFB] font-medium mb-8 leading-relaxed italic max-w-3xl">
              ...
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div className="flex items-center gap-4">
                  <motion.div 
                    className="w-14 h-14 rounded-full flex items-center justify-center text-[#F9FAFB] font-bold border-2 border-[rgba(212,175,55,0.4)]"
                ...
                <div className="flex items-center gap-4 px-4 py-2 rounded-full bg-[#10B981]/10 border border-[#10B981]/20">
                  <span className="text-sm text-[#9CA3AF]">{testimonials[currentIndex].metrics.before}</span>
          ...
          <div className="flex items-center justify-center gap-4 mt-8">
            <button
              onClick={prev}
              className="w-12 h-12 rounded-full glass flex items-center justify-center text-[#9CA3AF] hover:text-white hover:border-[rgba(0,240,255,0.3)] transition-all"
            >
